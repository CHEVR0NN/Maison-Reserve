          ...
          <>
            ...
            <div className="drawer-body">
              <div className="drawer-meta">
                ...
                <div><div className="k">Order Total</div><div className="v" style={{ color: "var(--amber-2)" }}>{SGD(selectedOrder.total)}</div></div>
              </div>
              ...
              <div style={{ marginTop: "10px" }}>
                {selectedOrder.lines.map((it, idx) => (
                  <div className="di-line" key={idx}>
                    <div>
                      <span style={{ fontFamily: "var(--mono)", fontSize: "11px", color: "var(--amber)" }}>{it.sku}</span>{" "}
                      &middot; {it.name}
                    </div>
                    <div>
